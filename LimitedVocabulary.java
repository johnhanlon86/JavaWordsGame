...
public class LimitedVocabulary{
    ...
    // Constructor with 1 parameter - word.
    public LimitedVocabulary(String word){
        this.word = word;
    }
    
    // Getter/Processing method to verify word against array above.
    public boolean verifyWord(String word) {
        for (int i = 0; i < words.length; i++) {
            if (word.equals(words[i])) {
                verifyWord = true;
                // Display message if in index.
                System.out.println("In index!");
            } else {
                // Do nothing.
            }
        }
        // Display message if not in index.
        if (verifyWord != true) {
